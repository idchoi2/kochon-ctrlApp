 ...
 * @usage
 * ```js
 * var ctrlApp = angular.module('reallyCoolApp', ['ionic']);
 *
 * ctrlApp.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('ctrlApp', ['ionic'])
