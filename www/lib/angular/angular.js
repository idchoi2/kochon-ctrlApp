 ...
 * ctrlApp.run(function($templateCache) {
 ...
 *
 * ```
 *  angular.module('ctrlApp', []).config(function($sceDelegateProvider) {
 ...
 *
 * ```
 * angular.module('ctrlAppWithSceDisabledctrlApp', []).config(function($sceProvider) {
